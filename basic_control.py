...
while True:
    ...
    print(lane_pose)
    print("Distance to road center: %0.2f" % (distance_to_road_center))
    print("Angle from straight (rad): %.2f" % (angle_from_straight_in_rads))
    print("\n")
    ...
    speed = 0#0.2 # TODO: You should overwrite this value
