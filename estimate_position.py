# This file contains all of the lane estimation functions for visual lane
# following. The estimate_position function takes an image and returns an
# estimated distance from the centerline and angle.
...
def compute_dist(quad, lin, car_pos, points, n=10):
...
def estimate_position(img, crop_val=120, new_left=270, new_right=350):
    ...
    dist = compute_dist(p_quad, p_lin, car_pos, points)
